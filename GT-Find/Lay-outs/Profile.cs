...
namespace GT_Find.Lay_outs
{
    public partial class Profile : Form
    {
            ...
            foreach (CheckBox checkBox in Controls.OfType<CheckBox>())
            {
                ...
                switch (checkBox.Name)
                {
                    ...
                    case "ded5":
                        ...
                        break;
                        // Add cases for other checkboxes and event handlers
                        // ...
                }
            }
        }
        ...
        // Event handlers for menu items and navigation
        // ...
        ...
        private int GetCheckboxValue(object sender)
        {
            ...
            // Get the category from the checkbox name (e.g., "fun1", "comp2", etc.)
            ...
            Debug.WriteLine("Checkbox name: " + checkBox.Name);
            Debug.WriteLine("Category name: " + categoryName);
